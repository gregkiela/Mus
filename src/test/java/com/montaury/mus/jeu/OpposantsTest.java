...
class OpposantsTest {
    ...
    void joueurs_devraient_tourner_correctement()
    {
        ...
        assertThat(opposants.joueurEskuEquipeEzku()).isEqualTo(joueur1);
        assertThat(opposants.joueurEskuEquipeZaku()).isEqualTo(joueur3);
        assertThat(opposants.joueurZakuEquipeEzku()).isEqualTo(joueur2);
        assertThat(opposants.joueurZakuEquipeZaku()).isEqualTo(joueur4);

        opposants.tourner();

        assertThat(opposants.joueurEskuEquipeEzku()).isEqualTo(joueur3);
        assertThat(opposants.joueurEskuEquipeZaku()).isEqualTo(joueur2);
        assertThat(opposants.joueurZakuEquipeEzku()).isEqualTo(joueur4);
        assertThat(opposants.joueurZakuEquipeZaku()).isEqualTo(joueur1);

        opposants.tourner();

        assertThat(opposants.joueurEskuEquipeEzku()).isEqualTo(joueur2);
        assertThat(opposants.joueurEskuEquipeZaku()).isEqualTo(joueur4);
        assertThat(opposants.joueurZakuEquipeEzku()).isEqualTo(joueur1);
